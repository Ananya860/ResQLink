    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="info-box">
                ...
                <p class="mb-0">
                    <?php if ($role_id == 2): ?>
                        You can manage disaster alerts, shelters, evacuation tracking, and emergency resources.
                    <?php else: ?>
                        Stay updated with alerts, find shelters, view resources, and update your evacuation status.
                    <?php endif; ?>
                </p>
            </div>
